...
def Type_Trot(direction, TM, s, h, sampling_time, L1, L2, L3, H):
    ...
    if direction == 5:
        ...
        for t in array:
            ...
            G0_Forward(TM, s, h, direction, t, L1, L2, L3, H)
    elif direction == 2:
        for t in array:
            time.sleep(sampling_time)
            Go_Backward(TM, s, h, direction, t, L1, L2, L3, H)
    else:
        print("dung 0")
    
    
def G0_Forward(TM, s, h, direction, t, L1, L2, L3, H):
    Arm_Forward_Trot_Frist(TM, s, h, direction, t, L1, L2, L3, H)
    time.sleep(0.07)
    Arm_Forward_Trot_Second(TM, s, h, direction, t, L1, L2, L3, H)
    time.sleep(0.07)
    Arm_Forward_Trot_Third(TM, s, h, direction, t, L1, L2, L3, H)
    time.sleep(0.07)
    Arm_Forward_Trot_Fourth(TM, s, h, direction, t, L1, L2, L3, H)
    time.sleep(0.07)
def Arm_Forward_Trot_Frist(TM, s, h, direction, t, L1, L2, L3, H):
    x1 = -L1
...
def Arm_Forward_Trot_Second(TM, s, h, direction, t, L1, L2, L3, H):
    x1 = -L1
    z1 = round(Congthuc_toado_ditoi_chan_truoc(TM, s, h, t, L1, L2, L3, H)[0],2)
    y1 = round(Congthuc_toado_ditoi_chan_truoc( TM, s, h, t, L1, L2, L3, H)[1],2)
    print("     toa do cua khau cuoi 1: x =", x1,", y =", y1,", z =", z1)
...
def Arm_Forward_Trot_Third(TM, s, h, direction, t, L1, L2, L3, H):
    x2 = L1
...
def Arm_Forward_Trot_Fourth(TM, s, h, direction, t, L1, L2, L3, H):
    x2 = L1
    z2 = round(Congthuc_toado_ditoi_chan_sau(TM, s, h, t, L1, L2, L3, H)[0],2)
    y2 = round(Congthuc_toado_ditoi_chan_sau(TM, s, h, t, L1, L2, L3, H)[1],2)
    print("     toa do cua khau cuoi 2: x =", x2,", y =", y2,", z =", z2)
...
def Go_Backward(TM, s, h, direction, t, L1, L2, L3, H):
    '''Neu a == 2 thi di lui '''
    x1 = -L1
...
def Type_Crawl(direction, TM, s, h, sampling_time, L1, L2, L3, H):
    ...
    if direction == 0:
        ...
        for t in array:
            time.sleep(sampling_time)
            G0_Forward_Crawl(TM, s, h, direction, t, L1, L2, L3, H)
    elif direction == 2:
        for t in array:
            time.sleep(sampling_time)
            Go_Backward(TM, s, h, direction, t, L1, L2, L3, H)
        ...
        print("dung 0")
def G0_Forward_Crawl(TM, s, h, direction, t, L1, L2, L3, H):
    Arm_Forward_Crawl_Frist(TM, s, h, direction, t, L1, L2, L3, H)
    time.sleep(0.07)
    Arm_Forward_Crawl_Second(TM, s, h, direction, t, L1, L2, L3, H)
    time.sleep(0.07)
    Arm_Forward_Crawl_Third(TM, s, h, direction, t, L1, L2, L3, H)
    time.sleep(0.07)
    Arm_Forward_Crawl_Fourth(TM, s, h, direction, t, L1, L2, L3, H)
    time.sleep(0.07)
def Arm_Forward_Crawl_Frist(TM, s, h, direction, t, L1, L2, L3, H):
    x1 = -L1
    z1 = round(Congthuc_toado_ditoi_chan_truoc(TM, s, h, t, L1, L2, L3, H)[0],2)
    y1 = round(Congthuc_toado_ditoi_chan_truoc( TM, s, h, t, L1, L2, L3, H)[1],2)
    print("     toa do cua khau cuoi 1: x =", x1,", y =", y1,", z =", z1)
    ...
    print('theta0 =',theta[0], 'theta1 =', theta[1], 'theta2 =', theta[2] )
    PCA_servo_control.Rot_Arm_RF(theta[0], theta[1], theta[2])
def Arm_Forward_Crawl_Second(TM, s, h, direction, t, L1, L2, L3, H):
    x1 = -L1
    z1 = round(Congthuc_toado_ditoi_chan_truoc(TM, s, h, t, L1, L2, L3, H)[0],2)
    y1 = round(Congthuc_toado_ditoi_chan_truoc( TM, s, h, t, L1, L2, L3, H)[1],2)
    print("     toa do cua khau cuoi 1: x =", x1,", y =", y1,", z =", z1)
    ...
    print('theta0 =',theta[0], 'theta1 =', theta[1], 'theta2 =', theta[2] )
    PCA_servo_control.Rot_Arm_LH(theta[0], theta[1], theta[2])
def Arm_Forward_Crawl_Third(TM, s, h, direction, t, L1, L2, L3, H):
    x2 = L1
    z2 = round(Congthuc_toado_ditoi_chan_sau(TM, s, h, t, L1, L2, L3, H)[0],2)
    y2 = round(Congthuc_toado_ditoi_chan_sau(TM, s, h, t, L1, L2, L3, H)[1],2)
    print("     toa do cua khau cuoi 2: x =", x2,", y =", y2,", z =", z2)
    ...
    print('beta0 =',beta[0], 'beta1 =', beta[1], 'beta2 =', beta[2] )
    PCA_servo_control.Rot_Arm_LF(beta[0], beta[1], beta[2])
def Arm_Forward_Crawl_Fourth(TM, s, h, direction, t, L1, L2, L3, H):
    x2 = L1
    z2 = round(Congthuc_toado_ditoi_chan_sau(TM, s, h, t, L1, L2, L3, H)[0],2)
    y2 = round(Congthuc_toado_ditoi_chan_sau(TM, s, h, t, L1, L2, L3, H)[1],2)
    print("     toa do cua khau cuoi 2: x =", x2,", y =", y2,", z =", z2)
