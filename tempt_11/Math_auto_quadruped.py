...
def G0_Forward(TM, s, h, direction, t, L1, L2, L3, H):
    Arm_Forward_Frist(TM, s, h, direction, t, L1, L2, L3, H)
    time.sleep(0.02)
    Arm_Forward_Second(TM, s, h, direction, t, L1, L2, L3, H)
    

def Arm_Forward_Frist(TM, s, h, direction, t, L1, L2, L3, H):
    x1 = -L1
...
def Arm_Forward_Second(TM, s, h, direction, t, L1, L2, L3, H):
    x2 = L1
